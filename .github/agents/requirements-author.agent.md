...
- Create or revise files only at the requested destination or a destination established by applicable project instructions.
...
1. Inspect supplied evidence, project instructions, and requested destination. State any missing essential information.
